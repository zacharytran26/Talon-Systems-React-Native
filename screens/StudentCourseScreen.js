...
const StudentCourse = () => {
  ...
  const fetchUnits = async () => {
    try {
      const querystring =
        `${authUser.host}` +
        `content?module=home&page=m&reactnative=1&accesscode=0200006733&uname=duser&password=1234&session_id=${authUser.sessionid}&customer=eta0000&mode=getcoursedetails&etamobilepro=1&nocache=n&persid=${authUser.currpersid}&persregid=${course.ID}`;
