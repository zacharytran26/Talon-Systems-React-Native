...
import {
  ...
  Image,Alert,
  ScrollView,
  RefreshControl, Dimensions, Button,
} from "react-native";
import {
  Layout,
  Text,
...
const CurrencyScreen = () => {
  ...
  const fValidatePIN = async () => {   
    const response = await fetch(
      ...
      }&mode=uploadpin&etamobilepro=1&nocache=${Math.random().toString().split(".")[1]
    ...
    .then((json) => {    
      ...
      Alert.alert("Unable to validate your PIN.  Please contact your ETA administrator for further assistance.");
          ...
          <View style={[styles.cardHeader, { backgroundColor }]}>
            ...
            <View style={styles.cardHeaderIcon}>
              {uri ? (
                ...
                <TouchableOpacity
                  style={styles.cardHeaderIcon}
                  onPress={() => {setSelectedCurry(item); toggleModalPINVisibility()}} // Open image picker if no URI
                >
                  <Icon
        ...
        <View style={styles.screenWrapper}>
          ...
          >
            ...
            <Modal animationType="slide" 
              transparent visible={isModalPINVisible} 
              ...
              <View style={styles.dialogPIN}>
                <View style={styles.modalView}>
                  <TextInput 
                    ...
                    value={PINValue} style={styles.textInput} 
                    onChangeText={(value) => setPINValue(value)} 
                  />
                  <View style={styles.buttonContainer}>
                  <Button title="Continue" onPress={fValidatePIN}/>
                  <Button title="Cancel" onPress={toggleModalPINVisibility}/>                  
                </View>
                </View>               
              </View>
            </Modal>
