...
const QualiScreen = ({ navigation }) => {
  ...
  const fetchQuali = async () => {
    ...
    try {
      const response = await fetch(
        `${authUser.host}content?module=home&page=m&reactnative=1&accesscode=&session_id=${authUser.sessionid}&customer=&mode=getqualification&etamobilepro=1&nocache=n&persid=${authUser.currpersid}`
      );
          ...
          <View style={styles.cardHeader}>
            ...
            {uri ? (
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate("QualiImage", { imageUri: uri })
                }
  ...
  const displayedQuali = quali.filter((qual) =>
    qual.QUAL.toLowerCase().includes(filter.toLowerCase())
  );
              ...
              <View style={styles.modalOverlay}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    navigation.navigate("QualiImage", { imageUri: image });
                  }}
                >
