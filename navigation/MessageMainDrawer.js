  ...
  return (
    ...
    >
      <SafeAreaView>
        ...
        <DrawerItem
          label="FIF"
          onPress={() => props.navigation.navigate("MessageFIF")}
        />
        <DrawerItem
          label="Instructors"
          onPress={() => props.navigation.navigate("MessageInstructorScreen")}
        />
        <DrawerItem
          label="Logbook"
          onPress={() => props.navigation.navigate("MessageLog")}
        />
        <DrawerItem
          label="Pending Authorizations"
          onPress={() => props.navigation.navigate("MessagePendingAuth")}
        />
        <DrawerItem
          label="Students"
          onPress={() => props.navigation.navigate("MessageStudentScreen")}
        />
        <DrawerItem
          label="Settings"
          onPress={() => props.navigation.navigate("MessageSettings")}
        />
        <DrawerItem
          label="Logout"
          onPress={() => props.navigation.navigate("MessageLogout")}
        />
      </SafeAreaView>
    </DrawerContentScrollView>
  );
