  ...
  return (
    ...
    >
      <SafeAreaView>
        ...
        <DrawerItem
          label="FIF"
          onPress={() => props.navigation.navigate("IssueFIF")}
        />
        <DrawerItem
          label="Instructors"
          onPress={() => props.navigation.navigate("IssueInstructorScreen")}
        />
        <DrawerItem
          label="Logbook"
          onPress={() => props.navigation.navigate("IssueLog")}
        />
        <DrawerItem
          label="Pending Authorizations"
          onPress={() => props.navigation.navigate("IssuePendingAuth")}
        />
        <DrawerItem
          label="Students"
          onPress={() => props.navigation.navigate("IssueStudentScreen")}
        />
        <DrawerItem
          label="Settings"
          onPress={() => props.navigation.navigate("IssueSettings")}
        />
        <DrawerItem
          label="Logout"
          onPress={() => props.navigation.navigate("IssueLogout")}
        />
      </SafeAreaView>
    </DrawerContentScrollView>
  );
